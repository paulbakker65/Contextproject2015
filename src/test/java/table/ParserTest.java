...
public class ParserTest {
	...
	public void testParseCorrect() throws IOException, ColumnTypeMismatchException {
		ArrayList<Column> columns = new ArrayList<Column>(Arrays.asList(new StringColumn("groente"), new StringColumn("saus")));
		Table expected = new Table();
		expected.add(new Record(columns, new Value[]{new StringValue("bloemkool"),new StringValue("mayonaise")}));
		expected.add(new Record(columns, new Value[]{new StringValue("spruitjes"), new StringValue("ketchup")}));
	...
	@Test
	public void testParseCorrectTimeDateLinks() throws IOException, ColumnTypeMismatchException, ParseException {
		ArrayList<Column> columns = new ArrayList<Column>(Arrays.asList(new TimeColumn("time", "hh:mm", "date"), new DateColumn("date", "ddMMyy")));
		Table expected = new Table();
