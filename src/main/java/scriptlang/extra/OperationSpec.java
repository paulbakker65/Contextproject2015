...
public class OperationSpec {
   ...
   * 
   * @param tables
   *          The tables argument is an ArrayList of Table objects containing all the tables that
   *          can be used for a operation.
   */
   ...
   *           If the operand list specifies an Table that is not available a TableNotFoundException
   *           is thrown.
   */
   ...
   * @return
   *    The Table object retrieved from tables.
   * @throws TableNotFoundException
   *    If the the table cannot be found in the tables field a TableNotFoundException is thrown.
   */
