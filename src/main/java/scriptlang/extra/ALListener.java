...
/**
 * ALListener is the implemented AnalysisLang Listener. It implements the methods required to parse
 * the script input.
 * 
 */
public class ALListener extends AnalysisLangBaseListener {
  ...
  /**
   * ALListener stands for AnalysisLangListener and extends AnalysisLangBaseListener. It is used to
   * catch the objects created by the parser.
   * 
   * @param tables
   *          The tables parameter is an ArrayList of all the tables the input parser has read.
   */
