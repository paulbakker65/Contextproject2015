...
public class AnalysisLangLexer extends Lexer {
  ...
  public static final String[] ruleNames = {"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6",
      "T__7", "T__8", "T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "ID", "EQ", "NEQ",
      "GEQ", "G", "LEQ", "L", "MULTIPLY", "DIVIDE", "PLUS", "MINUS", "MODULO", "NUMBER", "INT",
  ...
  public AnalysisLangLexer(final CharStream input) {
    super(input);
