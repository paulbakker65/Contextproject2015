...
public class ScriptVisitorTest {
   ...
   */
  @Test public final void testGetOperationList() {
   ...
   */
  @Test public void testBetweenOperation() {
   ...
   */
  @Test public void testChunkOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
   ...
   */
  @Test public void testCodeOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
    ...
    patternList.add(new PatternDescription(new SingleCount(1),
        new RecordMatchesConditionCondition("field",
            new Condition(CompareOperator.G, new NumberValue(10)))));
   ...
   */
  @Test public void testCompareOperation() {
   ...
   */
  @Test public void testComputeOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
    ...
    ComputeOperation expected = new ComputeOperation(tables.get(0),
        ComputeOperator.AVG, "field");
    List<Operation> parsedOperationList = visitor.getOperationList();
   ...
   */
  @Test public void testConnectOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
    ...
    ConnectionOperation expected = new ConnectionOperation(tables.get(0),
        tables.get(1), "field1", "field1");
    List<Operation> parsedOperationList = visitor.getOperationList();
   ...
   */
  @Test public void testConstraintOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
    ...
    ConstraintOperation expected = new ConstraintOperation(tables.get(1),
        "field1", CompareOperator.G, new NumberValue(10));
   ...
   */
  @Test public void testConvertOperation() {
   ...
   */
  @Test public void testForeachChunkOperation() {
    final ANTLRInputStream input = new ANTLRInputStream(
    ...
    ForEachChunkOperation expected = new ForEachChunkOperation(tables.get(0), 1,
        new ConstraintOperation(tables.get(0), "field3", CompareOperator.EQ,
            new NumberValue(10)));
