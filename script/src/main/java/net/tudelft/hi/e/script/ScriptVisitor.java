...
class ScriptVisitor extends AbstractParseTreeVisitor implements
  ...
  public final BetweenOperation visitBetween_param(Between_paramContext ctx) {
    try {
      return new BetweenOperation(getTableForTableName(visitField(ctx.eventcol)[0]), visitField(
          ctx.datecol1)[1], visitField(ctx.datecol2)[1], visitValue(ctx.value1),
  ...
  @Override
  public final Object visitCalc_operator(
    ...
    if (ctx.type != null) {
      try {
        return new ChunkingOperation(getTableForTableName(visitField(ctx.fieldparam)[0]),
            visitField(ctx.fieldparam)[1], visitChunk_type(ctx.type), (int) ((NumberValue) visitNumber(ctx.numberparam)).getValue());
      } catch (TableNotFoundException ex) {
        LOG.log(Level.SEVERE, ex.getMessage(), ex);
        return null;
      }
  ...
  @Override
  public final ChunkType visitChunk_type(
  ...
  public final ComputeOperation visitCompute_param(
    ...
    try {
      return new ComputeOperation(getTableForTableName(visitTable(ctx.tableparam)),
          visitCompute_operator(
              ctx.computeopparam), visitField(ctx.fieldparam)[1]);
    } catch (TableNotFoundException ex) {
      LOG.log(Level.SEVERE, ex.getMessage(), ex);
      return null;
    }
  ...
  @Override
  public final List<Condition> visitCondition(
  ...
  public final ConnectionOperation visitConnect_param(
    ...
    try {
      ...
      return new ConnectionOperation(getTableForTableName(firstField[0]), getTableForTableName(
          secondField[0]), firstField[1], secondField[1]);
    } catch (TableNotFoundException ex) {
      LOG.log(Level.SEVERE, ex.getMessage(), ex);
      return null;
    }
  ...
  @Override
  public final Object visitConvert_param(
      AnalysisLangParser.Convert_paramContext ctx) {
    return null;
  }

  @Override
  public final Object visitCount_pattern(
  ...
  @Override
  public final Object visitFormula(AnalysisLangParser.FormulaContext ctx) {
    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  }
  ...
  @Override
  public final LsaOperation visitLsa_param(
    ...
    try {
      ...
      return new LsaOperation(getTableForTableName(fieldReference[0]), fieldReference[1],
          visitNumberGetInt(ctx.from), visitNumberGetInt(ctx.to), visitValue(ctx.key), visitValue(
              ctx.target));
    } catch (TableNotFoundException ex) {
      LOG.log(Level.SEVERE, ex.getMessage(), ex);
      return null;
  ...
  @Override
  public final Object visitRange(AnalysisLangParser.RangeContext ctx) {
    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  }
