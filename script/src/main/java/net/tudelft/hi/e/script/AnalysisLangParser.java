...
public class AnalysisLangParser extends Parser {
  public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7,
      ...
      T__15 = 16, T__16 = 17, T__17 = 18, T__18 = 19, T__19 = 20, T__20 = 21, T__21 = 22, T__22 =
      23, T__23 = 24, ID = 25, EQ = 26, NEQ = 27, GEQ = 28, G = 29, LEQ = 30, L = 31, MULTIPLY = 32,
      DIVIDE = 33, PLUS = 34, MINUS = 35, MODULO = 36, AVG = 37, COUNT = 38, MAX = 39, MIN = 40,
      SUM = 41, STDDEV = 42, NUMBER = 43, WS = 44, STRING = 45, CHAR = 46;
  public static final int RULE_parse = 0, RULE_operation = 1, RULE_between_operation = 2,
      RULE_chunk_operation = 3, RULE_foreach_chunk_operation = 4, RULE_code_operation = 5,
      RULE_compute_operation = 6, RULE_connect_operation = 7, RULE_constraint_operation = 8,
      RULE_convert_operation = 9, RULE_lsa_operation = 10, RULE_between_param = 11,
      RULE_chunk_param = 12, RULE_chunk_type = 13, RULE_foreach_chunk_param = 14, RULE_code_param =
      15, RULE_compute_param = 16, RULE_connect_param = 17, RULE_constraint_param = 18,
      RULE_convert_param = 19, RULE_lsa_param = 20, RULE_table = 21, RULE_field = 22, RULE_pattern =
      23, RULE_record_condition = 24, RULE_count_pattern = 25, RULE_number = 26,
      RULE_compare_operator = 27, RULE_calc_operator = 28, RULE_compute_operator = 29,
      RULE_formula = 30, RULE_condition = 31, RULE_range = 32, RULE_value = 33, RULE_date = 34,
      RULE_text = 35;
  public static final String[] ruleNames =
      {"parse", "operation", "between_operation", "chunk_operation", "foreach_chunk_operation",
          ...
          "convert_operation", "lsa_operation", "between_param", "chunk_param", "chunk_type",
          "foreach_chunk_param", "code_param", "compute_param", "connect_param", "constraint_param",
          "convert_param", "lsa_param", "table", "field", "pattern", "record_condition",
          "count_pattern", "number", "compare_operator", "calc_operator", "compute_operator",
  ...
  private static final String[] _LITERAL_NAMES =
      {null, "'BETWEEN'", "'CHUNK'", "'FOR EACH CHUNK'", "'CODE'", "'COMPUTE'", "'CONNECT'",
          "'CONSTRAINT'", "'CONVERT'", "'LSA'", "'USING'", "'YEAR'", "'MONTH'", "'DAY'", "'ON'",
          "'AS'", "'TO'", "'['", "']'", "'].['", "'{'", "'}'", "'AND'", "'DATE('", "')'", null,
          "'=='", "'!='", "'>='", "'>'", "'<='", "'<'", "'*'", "'/'", "'+'", "'-'", "'%'",
          "'AVG()'", "'COUNT()'", "'MAX()'", "'MIN()'", "'SUM()'", "'STDDEV()'"};
  private static final String[] _SYMBOLIC_NAMES =
      {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
          null, null, null, null, null, null, null, null, null, null, "ID", "EQ", "NEQ", "GEQ", "G",
          "LEQ", "L", "MULTIPLY", "DIVIDE", "PLUS", "MINUS", "MODULO", "AVG", "COUNT", "MAX", "MIN",
  ...
  public final ParseContext parse() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _la = _input.LA(1);
        while ((((_la) & ~0x3f) == 0 &&
            ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3) | (1L << T__4)
  ...
  public final TableContext table() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(188);
        match(T__17);
        ((TableContext) _localctx).tablename = (((TableContext) _localctx).tablenameparam != null ?
  ...
  public final FieldContext field() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(195);
        match(T__17);
        ((FieldContext) _localctx).fieldname = (((FieldContext) _localctx).fieldnameparam != null ?
            ((FieldContext) _localctx).fieldnameparam.getText() :
            null);
        ((FieldContext) _localctx).tablename = (((FieldContext) _localctx).tablenameparam != null ?
          ...
          {
            {
              ...
              _localctx.patterndesc.add(
                  new PatternDescription(((PatternContext) _localctx).countparam.count,
    ...
    try {
      ...
      switch (getInterpreter().adaptivePredict(_input, 7, _ctx)) {
          ...
          enterOuterAlt(_localctx, 1);
        {
          ...
          ((Record_conditionContext) _localctx).recordcondition = new RecordOccurrenceCondition(
          ...
          enterOuterAlt(_localctx, 2);
        {
          ...
          ((Count_patternContext) _localctx).count = new SingleCount(
              (((Count_patternContext) _localctx).numberparam != null ?
                  Integer.valueOf(((Count_patternContext) _localctx).numberparam.getText()) :
                  0));
        }
        break;
        default:
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((NumberContext) _localctx).val = new NumberValue(
            (((NumberContext) _localctx).numparam != null ?
                Integer.valueOf(((NumberContext) _localctx).numparam.getText()) :
                0));
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
    ...
    try {
      ...
      switch (getInterpreter().adaptivePredict(_input, 12, _ctx)) {
          ...
          enterOuterAlt(_localctx, 1);
        {
          ...
          ((FormulaContext) _localctx).form =
              new Formula(((FormulaContext) _localctx).fieldparam.fieldname,
    ...
    try {
      ...
      switch (getInterpreter().adaptivePredict(_input, 13, _ctx)) {
          ...
          enterOuterAlt(_localctx, 1);
        {
          ...
          ((ConditionContext) _localctx).cond =
              new Condition(((ConditionContext) _localctx).opparam.op,
  ...
  public final DateContext date() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        calObj.set((((DateContext) _localctx).yearparam != null ?
            Integer.valueOf(((DateContext) _localctx).yearparam.getText()) :
            0), (((DateContext) _localctx).monthparam != null ?
            Integer.valueOf(((DateContext) _localctx).monthparam.getText()) :
            0), (((DateContext) _localctx).dayparam != null ?
            Integer.valueOf(((DateContext) _localctx).dayparam.getText()) :
            0));
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        String text = (((TextContext) _localctx).stringparam != null ?
            ((TextContext) _localctx).stringparam.getText() :
            null);
  ...
  public static class Between_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitBetween_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Chunk_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitChunk_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Foreach_chunk_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitForeach_chunk_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Code_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCode_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Compute_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCompute_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Connect_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConnect_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Constraint_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConstraint_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Convert_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConvert_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Lsa_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitLsa_operation(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Between_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitBetween_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Chunk_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitChunk_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Chunk_typeContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitChunk_type(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Foreach_chunk_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitForeach_chunk_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Code_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCode_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Compute_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCompute_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Connect_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConnect_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Constraint_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConstraint_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Convert_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConvert_param(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Record_conditionContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitRecord_condition(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Count_patternContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCount_pattern(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Compare_operatorContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCompare_operator(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Calc_operatorContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCalc_operator(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class Compute_operatorContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor)
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCompute_operator(this);
      else
        return visitor.visitChildren(this);
    }
  }
