...
public class AnalysisLangParser extends Parser {
  ...
  public static final int RULE_parse = 0, RULE_operation = 1, RULE_between_operation
      = 2,
      RULE_chunk_operation = 3, RULE_foreach_chunk_operation = 4, RULE_code_operation
      = 5,
      RULE_compute_operation = 6, RULE_connect_operation = 7, RULE_constraint_operation
      = 8,
      RULE_convert_operation = 9, RULE_lsa_operation = 10, RULE_between_param
      = 11,
      RULE_chunk_param = 12, RULE_chunk_type = 13, RULE_foreach_chunk_param = 14, RULE_code_param
      = 15, RULE_compute_param = 16, RULE_connect_param = 17, RULE_constraint_param
      = 18,
      RULE_convert_param = 19, RULE_lsa_param = 20, RULE_table = 21, RULE_field
      = 22, RULE_pattern = 23, RULE_record_condition = 24, RULE_count_pattern
      = 25, RULE_number = 26,
      RULE_compare_operator = 27, RULE_calc_operator = 28, RULE_compute_operator
      = 29,
      RULE_formula = 30, RULE_condition = 31, RULE_range = 32, RULE_value = 33, RULE_date
      = 34,
      RULE_text = 35;

  public static final String[] ruleNames = {"parse", "operation",
    "between_operation", "chunk_operation", "foreach_chunk_operation",
    "code_operation", "compute_operation", "connect_operation",
    "constraint_operation",
    "convert_operation", "lsa_operation", "between_param", "chunk_param",
    "chunk_type",
    "foreach_chunk_param", "code_param", "compute_param", "connect_param",
    "constraint_param",
    "convert_param", "lsa_param", "table", "field", "pattern",
    "record_condition",
    "count_pattern", "number", "compare_operator", "calc_operator",
    "compute_operator",
  ...
  private static final String[] _LITERAL_NAMES = {null, "'BETWEEN'", "'CHUNK'",
    "'FOR EACH CHUNK'", "'CODE'", "'COMPUTE'", "'CONNECT'",
  ...
  private static final String[] _SYMBOLIC_NAMES = {null, null, null, null, null,
    null, null, null, null, null, null, null, null, null, null,
    null, null, null, null, null, null, null, null, null, null, "ID", "EQ",
    "NEQ", "GEQ", "G",
    "LEQ", "L", "MULTIPLY", "DIVIDE", "PLUS", "MINUS", "MODULO", "AVG", "COUNT",
    "MAX", "MIN",
    "SUM", "STDDEV", "NUMBER", "WS", "STRING", "CHAR"};
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L
            << T__1) | (1L << T__2) | (1L << T__3) | (1L << T__4)
            | (1L << T__5) | (1L << T__6) | (1L << T__7) | (1L << T__8))) != 0)) {
          {
            {
              setState(72);
              operation();
  ...
  public final Foreach_chunk_operationContext foreach_chunk_operation()
      throws RecognitionException {
    Foreach_chunk_operationContext _localctx
        = new Foreach_chunk_operationContext(_ctx, getState());
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        match(T__2);
        setState(96);
        ((Foreach_chunk_operationContext) _localctx).param
            = foreach_chunk_param();
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
  ...
  public final Foreach_chunk_paramContext foreach_chunk_param() throws
      RecognitionException {
    Foreach_chunk_paramContext _localctx = new Foreach_chunk_paramContext(_ctx,
        getState());
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((TableContext) _localctx).tablename
            = (((TableContext) _localctx).tablenameparam != null
                ? ((TableContext) _localctx).tablenameparam.getText() : null);
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
      _errHandler.reportError(this, re);
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((FieldContext) _localctx).fieldname
            = (((FieldContext) _localctx).fieldnameparam != null
                ? ((FieldContext) _localctx).fieldnameparam.getText() : null);
        ((FieldContext) _localctx).tablename
            = (((FieldContext) _localctx).tablenameparam != null
                ? ((FieldContext) _localctx).tablenameparam.getText() : null);
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
      _errHandler.reportError(this, re);
          ...
          enterOuterAlt(_localctx, 2);
           {
            ...
            ((Count_patternContext) _localctx).count = new SingleCount(
                (((Count_patternContext) _localctx).numberparam != null
                    ? Integer.valueOf(
                        ((Count_patternContext) _localctx).numberparam.getText())
                    : 0));
          }
          break;
        default:
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((NumberContext) _localctx).val = new NumberValue(
            (((NumberContext) _localctx).numparam != null ? Integer.valueOf(
                    ((NumberContext) _localctx).numparam.getText()) : 0));
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
      _errHandler.reportError(this, re);
  ...
  public final Compute_operatorContext compute_operator() throws
      RecognitionException {
    Compute_operatorContext _localctx = new Compute_operatorContext(_ctx,
        getState());
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        calObj.set((((DateContext) _localctx).yearparam != null ? Integer.
            ...
            (((DateContext) _localctx).monthparam != null ? Integer.valueOf(
                    ((DateContext) _localctx).monthparam.getText()) : 0),
            (((DateContext) _localctx).dayparam != null ? Integer.valueOf(
                    ((DateContext) _localctx).dayparam.getText()) : 0));
  ...
  public static class ParseContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitParse(this);
      } else {
  ...
  public static class OperationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitOperation(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Between_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).
            visitBetween_operation(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Foreach_chunk_operationContext extends ParserRuleContext {
    ...
    public Foreach_chunk_operationContext(ParserRuleContext parent,
        int invokingState) {
      super(parent, invokingState);
    }
    ...
    @Override public int getRuleIndex() {
      return RULE_foreach_chunk_operation;
    }

    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).
            visitForeach_chunk_operation(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Code_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCode_operation(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Constraint_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).
            visitConstraint_operation(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Lsa_operationContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitLsa_operation(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Between_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitBetween_param(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Chunk_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitChunk_param(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Foreach_chunk_paramContext extends ParserRuleContext {
    ...
    public Foreach_chunk_paramContext(ParserRuleContext parent,
        int invokingState) {
      super(parent, invokingState);
    }
    ...
    @Override public int getRuleIndex() {
      return RULE_foreach_chunk_param;
    }

    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).
            visitForeach_chunk_param(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Compute_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCompute_param(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Connect_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConnect_param(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Convert_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitConvert_param(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Lsa_paramContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitLsa_param(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class TableContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitTable(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class FieldContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitField(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class PatternContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitPattern(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Count_patternContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCount_pattern(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class NumberContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitNumber(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class Calc_operatorContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCalc_operator(
            this);
      } else {
        return visitor.visitChildren(this);
      }
  ...
  public static class Compute_operatorContext extends ParserRuleContext {
    ...
    public TerminalNode AVG() {
      return getToken(AnalysisLangParser.AVG, 0);
    }

    public TerminalNode COUNT() {
      return getToken(AnalysisLangParser.COUNT, 0);
    }

    public TerminalNode MAX() {
      return getToken(AnalysisLangParser.MAX, 0);
    }

    public TerminalNode MIN() {
      return getToken(AnalysisLangParser.MIN, 0);
    }

    public TerminalNode STDDEV() {
      return getToken(AnalysisLangParser.STDDEV, 0);
    }

    public TerminalNode SUM() {
      return getToken(AnalysisLangParser.SUM, 0);
    }

    @Override public int getRuleIndex() {
      return RULE_compute_operator;
    }

    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).
            visitCompute_operator(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class FormulaContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitFormula(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class ConditionContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitCondition(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class RangeContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitRange(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class ValueContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitValue(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class DateContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitDate(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class TextContext extends ParserRuleContext {
    ...
    @Override public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnalysisLangVisitor) {
        return ((AnalysisLangVisitor<? extends T>) visitor).visitText(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
