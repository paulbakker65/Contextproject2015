...
public class AnalysisLangParser extends Parser {
  ...
  public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5
          ...
          = 40,
          CHAR = 41;
  public static final int RULE_parse = 0, RULE_operation = 1, RULE_between_operation
          = 2, RULE_chunk_operation = 3,
          RULE_code_operation = 4, RULE_compare_operation = 5, RULE_compute_operation
          = 6,
          RULE_connect_operation = 7, RULE_constraint_operation = 8, RULE_convert_operation
          = 9,
          RULE_lsa_operation = 10, RULE_between_param = 11, RULE_chunk_param
          = 12,
          RULE_chunk_type = 13, RULE_code_param = 14, RULE_compare_param = 15, RULE_compute_param
          = 16,
          RULE_connect_param = 17, RULE_constraint_param = 18, RULE_convert_param
          = 19,
          RULE_lsa_param = 20, RULE_table = 21, RULE_field = 22, RULE_pattern
          = 23,
  ...
  public static final String[] ruleNames = {
    "parse", "operation", "between_operation", "chunk_operation",
    "code_operation",
    "compare_operation", "compute_operation", "connect_operation",
    "constraint_operation",
    "convert_operation", "lsa_operation", "between_param", "chunk_param",
    "chunk_type", "code_param", "compare_param", "compute_param",
    "connect_param",
    "constraint_param", "convert_param", "lsa_param", "table", "field",
    "pattern",
    "record_condition", "count_pattern", "number", "compare_operator",
    "calc_operator",
  ...
  public final ParseContext parse() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _la = _input.LA(1);
        while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L
                << T__1) | (1L << T__2) | (1L << T__3) | (1L << T__4) | (1L
                << T__5) | (1L << T__6) | (1L << T__7) | (1L << T__8))) != 0)) {
          {
            {
              setState(70);
              operation();
  ...
  public static class Between_operationContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_between_operation;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterBetween_operation(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitBetween_operation(this);
      }
    }
  }

  public final Between_operationContext between_operation() throws
          RecognitionException {
    Between_operationContext _localctx = new Between_operationContext(_ctx,
            getState());
  ...
  public final Chunk_operationContext chunk_operation() throws
          RecognitionException {
    Chunk_operationContext _localctx = new Chunk_operationContext(_ctx,
            getState());
  ...
  public final Code_operationContext code_operation() throws
          RecognitionException {
    Code_operationContext _localctx
            = new Code_operationContext(_ctx, getState());
  ...
  public final Compare_operationContext compare_operation() throws
          RecognitionException {
    Compare_operationContext _localctx = new Compare_operationContext(_ctx,
            getState());
  ...
  public final Compute_operationContext compute_operation() throws
          RecognitionException {
    Compute_operationContext _localctx = new Compute_operationContext(_ctx,
            getState());
  ...
  public final Connect_operationContext connect_operation() throws
          RecognitionException {
    Connect_operationContext _localctx = new Connect_operationContext(_ctx,
            getState());
  ...
  public static class Constraint_operationContext extends ParserRuleContext {
    ...
    public Constraint_operationContext(ParserRuleContext parent,
            int invokingState) {
      super(parent, invokingState);
    }
  ...
  public final Constraint_operationContext constraint_operation() throws
          RecognitionException {
    Constraint_operationContext _localctx
            = new Constraint_operationContext(_ctx, getState());
  ...
  public final Convert_operationContext convert_operation() throws
          RecognitionException {
    Convert_operationContext _localctx = new Convert_operationContext(_ctx,
            getState());
  ...
  public static class Lsa_operationContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_lsa_operation;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterLsa_operation(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitLsa_operation(this);
      }
    }
  }
  ...
  public static class Between_paramContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_between_param;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterBetween_param(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitBetween_param(this);
      }
    }
  }
  ...
  public static class Chunk_typeContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_chunk_type;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterChunk_type(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitChunk_type(this);
      }
    }
  }
  ...
  public final Constraint_paramContext constraint_param() throws
          RecognitionException {
    Constraint_paramContext _localctx = new Constraint_paramContext(_ctx,
            getState());
  ...
  public static class Lsa_paramContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_lsa_param;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterLsa_param(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitLsa_param(this);
      }
    }
  }
  ...
  public static class TableContext extends ParserRuleContext {
    ...
    public TerminalNode ID() {
      return getToken(AnalysisLangParser.ID, 0);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterTable(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitTable(this);
      }
    }
  }
  ...
  public final TableContext table() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(186);
        match(T__18);
        ((TableContext) _localctx).tablename
                = (((TableContext) _localctx).tablenameparam != null
                        ? ((TableContext) _localctx).tablenameparam.getText()
                        : null);
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
  ...
  public final FieldContext field() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(193);
        match(T__18);
        ((FieldContext) _localctx).fieldname
                = (((FieldContext) _localctx).fieldnameparam != null
                        ? ((FieldContext) _localctx).fieldnameparam.getText()
                        : null);
        ((FieldContext) _localctx).tablename
                = (((FieldContext) _localctx).tablenameparam != null
                        ? ((FieldContext) _localctx).tablenameparam.getText()
                        : null);
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
  ...
  public static class PatternContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterPattern(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitPattern(this);
      }
    }
  }
  ...
  public final PatternContext pattern() throws RecognitionException {
    ...
    ((PatternContext) _localctx).patterndesc
          ...
          {
            {
              ...
              setState(198);
              ((PatternContext) _localctx).recordconditionparam
                      = record_condition();
              setState(199);
              match(T__21);
              _localctx.patterndesc.add(new PatternDescription(
                      ((PatternContext) _localctx).countparam.count,
                      ((PatternContext) _localctx).recordconditionparam.recordcondition));
            }
          }
          setState(204);
          _errHandler.sync(this);
  ...
  public static class Record_conditionContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_record_condition;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterRecord_condition(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitRecord_condition(this);
      }
    }
  }

  public final Record_conditionContext record_condition() throws
          RecognitionException {
    Record_conditionContext _localctx = new Record_conditionContext(_ctx,
            getState());
          ...
          enterOuterAlt(_localctx, 1);
           {
            ...
            ((Record_conditionContext) _localctx).recordcondition
                    = new RecordOccurrenceCondition(
                            ((Record_conditionContext) _localctx).tableparam.tablename);
          }
          break;
        case 2:
          enterOuterAlt(_localctx, 2);
           {
            setState(209);
            ((Record_conditionContext) _localctx).fieldparam
                    = ((Record_conditionContext) _localctx).field = field();
            setState(210);
            ((Record_conditionContext) _localctx).conditionparam = condition();
            ((Record_conditionContext) _localctx).recordcondition
                    = new RecordMatchesConditionCondition(
                            ((Record_conditionContext) _localctx).field.fieldname,
                            ((Record_conditionContext) _localctx).conditionparam.cond);
          }
          break;
      }
    } catch (RecognitionException re) {
  ...
  public static class Count_patternContext extends ParserRuleContext {
    ...
    @Override public int getRuleIndex() {
      return RULE_count_pattern;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterCount_pattern(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitCount_pattern(this);
      }
    }
  }
          ...
          enterOuterAlt(_localctx, 2);
           {
            ...
            ((Count_patternContext) _localctx).count = new SingleCount(
                    (((Count_patternContext) _localctx).numberparam != null
                            ? Integer.valueOf(
                                    ((Count_patternContext) _localctx).numberparam.
                                    getText()) : 0));
          }
          break;
        default:
  ...
  public final NumberContext number() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((NumberContext) _localctx).val = new NumberValue(
                (((NumberContext) _localctx).numparam != null ? Integer.valueOf(
                                ((NumberContext) _localctx).numparam.getText())
                        : 0));
      }
    } catch (RecognitionException re) {
      _localctx.exception = re;
  ...
  public final Compare_operatorContext compare_operator() throws
          RecognitionException {
    Compare_operatorContext _localctx = new Compare_operatorContext(_ctx,
            getState());
          ...
          enterOuterAlt(_localctx, 1);
           {
            ...
            ((FormulaContext) _localctx).form = new Formula(
                    ((FormulaContext) _localctx).fieldparam.fieldname,
                    ((FormulaContext) _localctx).opparam.op,
                    ((FormulaContext) _localctx).anotherfieldparam.fieldname);
          }
          break;
        case 2:
          enterOuterAlt(_localctx, 2);
           {
            ...
            ((FormulaContext) _localctx).form = new Formula(
                    ((FormulaContext) _localctx).fieldparam.fieldname,
                    ((FormulaContext) _localctx).opparam.op,
                    ((FormulaContext) _localctx).valueparam.val);
          }
          break;
        case 3:
          enterOuterAlt(_localctx, 3);
           {
            ...
            ((FormulaContext) _localctx).form = new Formula(
                    ((FormulaContext) _localctx).fieldparam.fieldname,
                    ((FormulaContext) _localctx).opparam.op,
                    ((FormulaContext) _localctx).formulaparam.form);
          }
          break;
      }
    } catch (RecognitionException re) {
          ...
          enterOuterAlt(_localctx, 1);
           {
            ...
            ((ConditionContext) _localctx).cond = new Condition(
                    ((ConditionContext) _localctx).opparam.op,
                    ((ConditionContext) _localctx).valueparam.val);
          }
          break;
        case 2:
          enterOuterAlt(_localctx, 2);
          ...
          enterOuterAlt(_localctx, 1);
           {
            ...
            ((ValueContext) _localctx).val
                    = ((ValueContext) _localctx).dataparam.val;
          }
          break;
        case NUMBER:
          enterOuterAlt(_localctx, 2);
           {
            ...
            ((ValueContext) _localctx).val
                    = ((ValueContext) _localctx).numparam.val;
          }
          break;
        case STRING:
          enterOuterAlt(_localctx, 3);
           {
            ...
            ((ValueContext) _localctx).val
                    = ((ValueContext) _localctx).stringparam.val;
          }
          break;
        default:
          throw new NoViableAltException(this);
  ...
  public static class DateContext extends ParserRuleContext {
    ...
    public List<TerminalNode> NUMBER() {
      return getTokens(AnalysisLangParser.NUMBER);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).enterDate(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnalysisLangListener) {
        ((AnalysisLangListener) listener).exitDate(this);
      }
    }
  }
  ...
  public final DateContext date() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        calObj.set((((DateContext) _localctx).yearparam != null ? Integer.
                valueOf(((DateContext) _localctx).yearparam.getText()) : 0),
                (((DateContext) _localctx).monthparam != null ? Integer.valueOf(
                                ((DateContext) _localctx).monthparam.getText())
                        : 0), (((DateContext) _localctx).dayparam != null
                        ? Integer.valueOf(((DateContext) _localctx).dayparam.
                                getText()) : 0));
  ...
  public final TextContext text() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        String text = (((TextContext) _localctx).stringparam != null
                ? ((TextContext) _localctx).stringparam.getText() : null);
