...
public interface AnalysisLangVisitor<T> extends ParseTreeVisitor<T> {
   ...
   * {@link AnalysisLangParser#between_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitBetween_operation(
      @NotNull AnalysisLangParser.Between_operationContext ctx);
  ...
  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#foreach_chunk_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitForeach_chunk_operation(
      @NotNull AnalysisLangParser.Foreach_chunk_operationContext ctx);
  ...
  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#compute_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitCompute_operation(
      @NotNull AnalysisLangParser.Compute_operationContext ctx);

  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#connect_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitConnect_operation(
      @NotNull AnalysisLangParser.Connect_operationContext ctx);

  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#constraint_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitConstraint_operation(
      @NotNull AnalysisLangParser.Constraint_operationContext ctx);

  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#convert_operation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitConvert_operation(
      @NotNull AnalysisLangParser.Convert_operationContext ctx);
  ...
  /**
   * Visit a parse tree produced by
   * {@link AnalysisLangParser#foreach_chunk_param}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitForeach_chunk_param(
      @NotNull AnalysisLangParser.Foreach_chunk_paramContext ctx);
   ...
   * @return the visitor result
   */
  T visitConstraint_param(
      @NotNull AnalysisLangParser.Constraint_paramContext ctx);
   ...
   * @return the visitor result
   */
  T visitRecord_condition(
      @NotNull AnalysisLangParser.Record_conditionContext ctx);
   ...
   * @return the visitor result
   */
  T visitCompare_operator(
      @NotNull AnalysisLangParser.Compare_operatorContext ctx);
   ...
   * @return the visitor result
   */
  T visitCompute_operator(
      @NotNull AnalysisLangParser.Compute_operatorContext ctx);
